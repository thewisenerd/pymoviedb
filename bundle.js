...
function write_elem(content, count){
	...
	*/
	...
	writeback += '				<a target="_blank" href="http://php-thewisenerd.rhcloud.com/mailgun-php/?title=' + Base64.encode (content[0]) +  '" class="btn btn-danger btn-fab btn-raised mdi-alert-error" title="report movie"></a>' + "\n";
	...
	$.ajax({
		...
		if (response.Response == "False") {
			...
			if (response.Poster == "N/A") {
				...
				$('#dialog-img-'+containerid).html("<img src=\"http://php-thewisenerd.rhcloud.com/spoof_referer.php?url=" + Base64.encode(response.Poster) + "&referer=" + Base64.encode(imdb_reflink) + "&content=image&type=jpeg\" width=\"100%\" min-height=\"66px\" onerror=\"this.onerror=null;this.src='assets/images/poster-not-available.jpg';show_err();\" \"></img>");
			}
