	...
	$.ajax({
		...
		if (response.Response == "False") {
			...
			if (response.Poster == "N/A") {
				...
				$('#dialog-img-'+containerid).html("<img src=\"http://myphp-thewisenerd.rhcloud.com/spoof_referer.php?url=" + Base64.encode(response.Poster) + "&referer=" + Base64.encode(imdb_reflink) + "&content=image&type=jpeg\" width=\"100%\" min-height=\"66px\" onerror=\"this.onerror=null;this.src='assets/images/poster-not-available.jpg';show_err();\" \"></img>");
			}
