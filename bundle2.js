...
function write_elem(content, count){
	...
	*/
	...
	writeback += '	</td>' + "\n";
	writeback += '	<td>' + content[2] + '</td>' + "\n";
	writeback += '	<td>' + content[3] + '</td>' + "\n";
	writeback += '	<td>' + content[4] + '</td>' + "\n";
	writeback += '	<td>' + content[5].split(',')[0] + '</td>' + "\n";
	writeback += '	<td>' + content[6] + '</td>' + "\n";
	writeback += '</tr>' + "\n";
...
*/
	...
	writeback += '				<a target="_blank" href="http://php.thewisenerd.changeip.org/send_report.php?title=' + Base64.encode (content[0]) +  '" class="btn btn-danger btn-fab btn-raised mdi-alert-error" title="report movie"></a>' + "\n";
...
var qual_from_string = function(str) {
	//console.log(str.substr(0, str.indexOf('p')));
	...
	callback = function(response) {
		...
		var table = $("table").stupidtable({
			...
			"year":function(a, b) {
				...
				aYear = year_from_string(a);
				bYear = year_from_string(b);
